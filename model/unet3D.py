...
class UNet3D(Module):
    ...
    def __init__(self,num_channels=3, feat_channels=[64, 128, 256, 512, 1024], residual='conv'):
...
class Conv3D_Block(Module):
    ...
    def __init__(self, inp_feat, out_feat, kernel=(1, 3, 3), stride=1, padding=(0, 1, 1), residual=None):
